...
export const RESTAURANTS = [
  ...
  // District Hotel 1: Kannur
  {
    id: 'rest-kannur',
    name: "Kannur Sahib's Thalassery Biryani & Grill",
    category: 'indian',
    rating: 4.96,
    reviewsCount: 890,
    deliveryTime: '15-25 min',
    ...
    isTopRated: true,
    isVeg: false,
    offerText: 'Kannur Special 40% OFF',
    image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=800&q=80',
    coverImage: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1200&q=80',
    address: 'Fort Road, Kannur, Kerala',
    description: 'World-famous Thalassery Dum Biryani, Kannur cocktail chicken fry, and Malabar snacks.',
    menu: [
      { id: 'item-kannur-1', name: 'Kannur Thalassery Chicken Dum Biryani', categoryName: 'Thalassery Specials', price: 249, description: 'Short grain Kaima rice infused with pure ghee, tender chicken, cashews & raisins.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-kannur-2', name: 'Kannur Crispy Cocktail Chicken Fry', categoryName: 'Starters', price: 279, description: 'Spiced bite-sized chicken roasted with shallots, crushed pepper & curry leaves.', image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-kannur-3', name: 'Malabar Unnakaya (3 pcs)', categoryName: 'Snacks', price: 99, description: 'Mashed banana stuffed with sweetened coconut & fried till golden.', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=500&q=80', isVeg: true, isPopular: false }
    ]
  },

  // District Hotel 2: Kozhikode
  {
    id: 'rest-kozhikode',
    name: 'Kozhikode Royal Paragon Biryani & Halwa',
    category: 'indian',
    rating: 4.98,
    reviewsCount: 1250,
    deliveryTime: '15-25 min',
    ...
    description: 'Legendary Calicut Mutton Dum Biryani, Fish Mango Curry, and authentic Kozhikkodan Black Halwa.',
    menu: [
      { id: 'item-cal-1', name: 'Calicut Signature Mutton Dum Biryani', categoryName: 'Calicut Specials', price: 349, description: 'Short grain Kaima rice cooked in ghee with tender slow cooked mutton.', image: 'https://images.unsplash.com/photo-1633945274405-b6c8069047b0?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-cal-2', name: 'Kozhikode Raw Mango Fish Curry', categoryName: 'Curries', price: 329, description: 'Seer fish cooked with green raw mangoes & coconut gravy.', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-cal-3', name: 'Kozhikkodan Black Halwa Box', categoryName: 'Desserts', price: 149, description: 'Authentic rich ghee halwa prepared with jaggery & dry fruits.', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=500&q=80', isVeg: true, isPopular: true }
    ]
  },

  // District Hotel 3: Kollam
  {
    id: 'rest-kollam',
    name: 'Kollam Ashtamudi Seafood & Duck Roast',
    category: 'seafood',
    rating: 4.89,
    reviewsCount: 780,
    deliveryTime: '20-30 min',
    ...
    isTopRated: true,
    isVeg: false,
    offerText: 'Backwater Fresh',
    image: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?auto=format&fit=crop&w=800&q=80',
    coverImage: 'https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1200&q=80',
    address: 'Chinnakada, Kollam, Kerala',
    description: 'Fresh Ashtamudi crab fry, Kollam Kuttanadan duck roast, and prawns roast with appam.',
    menu: [
      { id: 'item-kollam-1', name: 'Ashtamudi Spicy Mud Crab Fry', categoryName: 'Seafood', price: 399, description: 'Fresh mud crabs roasted with crushed black pepper & roasted coconut.', image: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-kollam-2', name: 'Kollam Special Kuttanadan Duck Roast', categoryName: 'Mains', price: 379, description: 'Farm duck slow roasted in caramelized onion gravy & Kerala spices.', image: 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-kollam-3', name: 'Hot Appam & Veg Stew Set', categoryName: 'Breads', price: 139, description: 'Lacy soft rice hoppers served with coconut milk stew.', image: 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=500&q=80', isVeg: true, isPopular: false }
    ]
  },

  // District Hotel 4: Trivandrum
  {
    id: 'rest-trivandrum',
    name: 'Trivandrum Imperial Chicken Fry & Boli',
    category: 'indian',
    rating: 4.87,
    reviewsCount: 940,
    deliveryTime: '20-30 min',
    ...
    isTopRated: true,
    isVeg: false,
    offerText: 'Trivandrum Special',
    image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=800&q=80',
    coverImage: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=1200&q=80',
    address: 'Technopark, Trivandrum, Kerala',
    description: 'Iconic Trivandrum chili chicken fry, Trivandrum Boli with Payasam, and parotta.',
    menu: [
      { id: 'item-tvm-1', name: 'Trivandrum Spicy Red Chili Chicken Fry', categoryName: 'Starters', price: 269, description: 'Deep fried crispy chicken tossed in red chili garlic Kerala spices.', image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-tvm-2', name: 'Trivandrum Sweet Boli & Palada Payasam', categoryName: 'Desserts', price: 149, description: 'Golden lentil Boli served with warm creamy Palada Payasam.', image: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?auto=format&fit=crop&w=500&q=80', isVeg: true, isPopular: true }
    ]
  },

  // District Hotel 5: Thrissur
  {
    id: 'rest-thrissur',
    name: 'Thrissur Heritage Sadya & Beef Roast',
    category: 'indian',
    rating: 4.91,
    reviewsCount: 650,
    deliveryTime: '20-30 min',
    ...
    isTopRated: true,
    isVeg: false,
    offerText: 'Heritage Taste',
    image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=800&q=80',
    coverImage: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1200&q=80',
    address: 'Swaraj Round, Thrissur, Kerala',
    description: 'Traditional Thrissur Grand Veg Sadya, spicy slow-cooked beef fry with porous parotta.',
    menu: [
      { id: 'item-tcr-1', name: 'Thrissur Slow Cooked Beef Fry & Parotta', categoryName: 'Mains', price: 289, description: 'Tender beef fry cooked with coconut bites served with 3 parottas.', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true },
      { id: 'item-tcr-2', name: 'Thrissur Grand Banana Leaf Veg Sadya', categoryName: 'Sadya', price: 219, description: '24 item Kerala traditional feast with Avial, Sambar, Payasam & chips.', image: 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=500&q=80', isVeg: true, isPopular: true }
    ]
  },

  // District Hotel 6: Kottayam
  {
    id: 'rest-kottayam',
    name: 'Kottayam Meen Vejitha & Duck Curry',
    category: 'seafood',
    rating: 4.88,
    reviewsCount: 540,
    deliveryTime: '20-30 min',
    ...
    isTopRated: true,
    isVeg: false,
    offerText: 'Kottayam Curry',
    image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80',
    coverImage: 'https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1200&q=80',
    address: 'Kanjikuzhy, Kottayam, Kerala',
    description: 'Kottayam red spicy fish curry, tapioca (Kappa) with spicy fish gravy.',
    menu: [
      { id: 'item-ktm-1', name: 'Kottayam Red Fiery Fish Curry with Kappa', categoryName: 'Mains', price: 249, description: 'Steamed mashed tapioca served with spicy red fish curry.', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=500&q=80', isVeg: false, isPopular: true }
    ]
  }
];
