                    ...
                    {loading ? (
                      ...
                      filteredCandidates.map((user) => (
                        ...
                        >
                          ...
                          <span style={{ fontSize: '0.7rem', background: 'var(--bg-main)', padding: '0.15rem 0.4rem', borderRadius: 'var(--radius-sm)', color: 'var(--text-muted)', fontWeight: '800' }}>
                            {user.role}
                          </span>
                        </div>
                      ))
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.4rem', marginTop: '0.15rem' }}>
                      <span style={{ fontSize: '0.68rem', background: 'var(--bg-subtle)', color: 'var(--text-muted)', padding: '0.1rem 0.4rem', borderRadius: 'var(--radius-sm)', fontWeight: '800' }}>
