        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <div style={{
                background: partner.isVerified ? '#e6f4ea' : '#fdf2f2',
                ...
                <span style={{
                  color: partner.isVerified ? '#137333' : '#b91c1c',
                  fontSize: '1.1rem',
                  fontWeight: '900'
                }}>
                ...
                {!partner.isVerified ? (
                  ...
                  <p style={{ fontSize: '0.78rem', color: '#137333', margin: 0, fontWeight: '600', lineHeight: '1.4' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f1f5f9', paddingTop: '1rem' }}>
              ...
              <span style={{
                background: partner.isActive ? '#e6f4ea' : '#fce8e6',
                color: partner.isActive ? '#137333' : '#c5221f',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{
                background: partner.isOnline ? '#e8f0fe' : '#f1f5f9',
                color: partner.isOnline ? '#1a73e8' : 'var(--text-muted)',
                padding: '0.2rem 0.6rem',
                borderRadius: 'var(--radius-sm)',
                fontSize: '0.72rem',
                fontWeight: '850',
                ...
                <span style={{ width: '5px', height: '5px', borderRadius: '50%', background: partner.isOnline ? '#1a73e8' : 'var(--text-muted)' }}></span>
                    ...
                    history.map((h) => (
                      <tr key={h.id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                        ...
                        <td style={{ padding: '0.85rem 0.5rem' }}>
                          <span style={{ fontSize: '0.65rem', color: h.paymentStatus === 'paid' ? '#137333' : '#b06000', fontWeight: '800', background: h.paymentStatus === 'paid' ? '#e6f4ea' : '#fef7e0', padding: '0.15rem 0.4rem', borderRadius: 'var(--radius-sm)' }}>
      ...
      {showVerifyModal && (
        <div style={{
          ...
          <div style={{
            ...
            {verifyError && (
              <div style={{ color: '#b91c1c', fontSize: '0.82rem', fontWeight: '700', marginBottom: '1.25rem' }}>
                {verifyError}
              </div>
            )}
