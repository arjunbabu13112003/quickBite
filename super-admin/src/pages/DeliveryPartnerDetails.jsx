        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.4rem', marginTop: '0.3rem', flexWrap: 'wrap' }}>
              ...
              <span style={{
                background: partner.isVerified ? '#e6f4ea' : '#fef7e0',
                color: partner.isVerified ? '#137333' : '#b06000',
                padding: '0.2rem 0.6rem',
                borderRadius: 'var(--radius-sm)',
                fontSize: '0.7rem',
                fontWeight: '800'
              ...
              {/* Online status badge */}
              <span style={{
                background: partner.isOnline ? '#e6f4ea' : '#f1f5f9',
                color: partner.isOnline ? '#137333' : 'var(--text-muted)',
                padding: '0.2rem 0.6rem',
                borderRadius: 'var(--radius-sm)',
                fontSize: '0.7rem',
                fontWeight: '800'
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', marginTop: '0.25rem' }}>
                ...
                {partner.licenseNumber && <ShieldCheck size={14} style={{ color: '#137333' }} />}
              </div>
            </div>
                      ...
                      <tr key={h.id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                        ...
                        <td style={{ padding: '0.85rem 0.5rem' }}>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem' }}>
                            ...
                            <span style={{ fontSize: '0.65rem', color: h.paymentStatus === 'paid' ? '#137333' : '#b06000', fontWeight: '800' }}>
