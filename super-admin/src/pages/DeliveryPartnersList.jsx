...
export default function DeliveryPartnersList({ onNavigate }) {
  ...
  const renderVerificationBadge = (isVerified) => {
    return (
      <span style={{
        ...
        color: isVerified ? '#137333' : 'var(--text-muted)',
        ...
        {isVerified ? (
          <>
            <span style={{ width: '5px', height: '5px', borderRadius: '50%', background: '#137333' }}></span>
            <span>Verified</span>
          </>
        ) : (
          <span>Pending</span>
  ...
  const renderOnlineBadge = (isOnline) => {
    return (
      <span style={{
        background: isOnline ? '#e8f0fe' : '#f1f5f9',
        color: isOnline ? '#1a73e8' : 'var(--text-muted)',
        padding: '0.2rem 0.5rem',
        borderRadius: 'var(--radius-sm)',
        fontSize: '0.72rem',
        fontWeight: '800',
  ...
  const renderAvailabilityBadge = (partner) => {
    ...
    return (
      <span style={{
        background: isAvail ? '#e6f4ea' : '#fef7e0',
        color: isAvail ? '#137333' : '#b06000',
        padding: '0.2rem 0.5rem',
        borderRadius: 'var(--radius-sm)',
        fontSize: '0.72rem',
        fontWeight: '800',
