        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
              ...
              <h4 style={{ fontSize: '1.15rem', fontWeight: '900', color: '#991b1b' }}>Attention Required</h4>
            </div>
              ...
              {attentionItems.length > 0 ? (
                attentionItems.map((item) => (
                  <div key={item.id} style={{
                    ...
                    <div>
                      <div style={{ fontSize: '0.85rem', fontWeight: '800', color: '#991b1b' }}>{item.label}</div>
                      <div style={{ fontSize: '0.75rem', color: '#b91c1c', marginTop: '0.1rem' }}>{item.detail}</div>
                    </div>
                  </div>
                ))
              ) : (
          ...
          <div style={{
            ...
            {/* Progress bar */}
            <div style={{ width: '100%', height: '8px', background: '#f1f5f9', borderRadius: '4px', overflow: 'hidden', marginBottom: '1.25rem' }}>
                        ...
                        <tr key={hotel.id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                          <td style={{ padding: '0.9rem 1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            {hotel.imageUrl ? (
                              ...
                              <div style={{ width: '32px', height: '32px', borderRadius: '6px', background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', color: 'var(--text-subtle)' }}>
