...
export default function OrderDetails({ id, onNavigate }) {
  ...
  const renderDeliveryAssignmentCardContent = () => {
    ...
    if (status === 'delivered') {
      return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', alignItems: 'center', textAlign: 'center', padding: '1.5rem 0' }}>
          <CheckCircle size={32} style={{ color: '#137333' }} />
          <div>
    ...
    if (status === 'cancelled' || status === 'rejected') {
      return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', alignItems: 'center', textAlign: 'center', padding: '1.5rem 0' }}>
          <XCircle size={32} style={{ color: '#c5221f' }} />
          <div>
  ...
  return (
    <>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.82rem' }}>
              ...
              {parseFloat(order.discountAmount || 0) > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', color: '#137333', fontWeight: '700' }}>
            ...
            <div style={{ padding: '1.25rem 1.75rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', flex: 1, overflowY: 'auto' }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.65rem', overflowY: 'auto', minHeight: '200px', maxHeight: '280px', paddingRight: '0.25rem' }}>
                {loadingPartners ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, gap: '0.5rem', color: '#c5221f', fontSize: '0.82rem', fontWeight: '700', minHeight: '200px' }}>
                    ...
                    return (
                      <label
                        ...
                        style={{
                          ...
                          background: isSelected ? '#fff2e8' : '#ffffff',
                          cursor: 'pointer',
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', flexWrap: 'wrap' }}>
                              ...
                              <span style={{ background: '#e6f4ea', color: '#137333', fontSize: '0.55rem', fontWeight: '800', padding: '0.1rem 0.35rem', borderRadius: '2px' }}>
                                VERIFIED
                              </span>
                              <span style={{ background: '#e8f0fe', color: '#1a73e8', fontSize: '0.55rem', fontWeight: '800', padding: '0.1rem 0.35rem', borderRadius: '2px' }}>
                                ONLINE
                              </span>
                              <span style={{ background: '#e6f4ea', color: '#137333', fontSize: '0.55rem', fontWeight: '800', padding: '0.1rem 0.35rem', borderRadius: '2px' }}>
                                AVAILABLE
      ...
      {order && (
        <div id="printable-invoice" style={{ fontFamily: 'sans-serif', color: '#000000', background: '#ffffff', lineHeight: 1.5 }}>
          ...
          {(order.orderStatus === 'cancelled' || order.orderStatus === 'rejected') && (
            <div style={{ border: '2px solid #ef4444', background: '#fef2f2', padding: '1rem', borderRadius: '4px', marginBottom: '1.5rem', textAlign: 'center' }}>
              <h3 style={{ margin: 0, color: '#b91c1c', fontSize: '1rem', fontWeight: '950', textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', background: '#f9fafb', padding: '1.25rem', borderRadius: '6px', marginBottom: '2rem', border: '1px solid #e5e7eb', fontSize: '0.82rem' }}>
            ...
            <div>
              ...
              <strong style={{ color: order.paymentStatus === 'paid' ? '#15803d' : '#b45309', textTransform: 'uppercase' }}>
