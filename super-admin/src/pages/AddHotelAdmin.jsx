              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', marginTop: '0.25rem', paddingTop: '0.75rem', borderTop: '1px solid var(--bg-subtle)' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.82rem' }}>
                    ...
                    <span style={{
                      background: selectedHotel.isActive ? '#e6f4ea' : '#fce8e6',
                      color: selectedHotel.isActive ? '#137333' : '#c5221f',
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.82rem' }}>
                    ...
                    <span style={{
                      background: selectedHotel.isOpen ? '#e6f4ea' : '#f1f5f9',
                      color: selectedHotel.isOpen ? '#137333' : 'var(--text-muted)',
                      padding: '0.15rem 0.5rem',
                      borderRadius: 'var(--radius-sm)',
                      fontSize: '0.72rem',
                      fontWeight: '800'
