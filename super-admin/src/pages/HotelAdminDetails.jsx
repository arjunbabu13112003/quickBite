                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.4rem', marginTop: '0.2rem', flexWrap: 'wrap' }}>
                        <span style={{
                          background: assignment.hotelIsActive ? '#e6f4ea' : '#fce8e6',
                          color: assignment.hotelIsActive ? '#137333' : '#c5221f',
                        ...
                        <span style={{
                          background: assignment.hotelIsOpen ? '#e6f4ea' : '#f1f5f9',
                          color: assignment.hotelIsOpen ? '#137333' : 'var(--text-muted)',
                          padding: '0.15rem 0.4rem',
                          borderRadius: 'var(--radius-sm)',
                          fontSize: '0.68rem',
                          fontWeight: '800'
